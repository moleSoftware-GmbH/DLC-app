...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/scene_2_atlas_.png", id:"scene_2_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"scene_2_atlas_", frames: [[842,0,642,827],[0,0,840,1968],[988,984,60,100],[842,984,144,66],[842,829,208,153],[842,1052,61,20]]}
];
...
(lib.Bitmap1 = function() {
	this.spriteSheet = ss["scene_2_atlas_"];
	this.gotoAndStop(0);
...
this.initialize(mode,startPosition,loop,{});
	...
	this.playCuckoo = function(){
		this.gotoAndPlay(89);
		
	},
	this.stopCuckoo = function(){
		this.gotoAndPlay(1);
	},	
...
})(scene_2_libs = scene_2_libs||{}, images = images||{}, createjs = createjs||{}, ss = ss||{});
var scene_2_libs, images, createjs, ss;
